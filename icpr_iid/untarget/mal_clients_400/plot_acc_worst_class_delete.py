...
group=[400,300,500,700,900]
client=[400,300,500,700,900]
...
# pklファイルから配列を読み込みます
with open('delete_untarget_'+str(group[idx])+'_worst_class.pkl', 'rb') as f:
...
txt="delete_untarget_"+str(group[idx])+"_worst_class.png"
plt.savefig(txt)
plt.clf()
plt.close()
