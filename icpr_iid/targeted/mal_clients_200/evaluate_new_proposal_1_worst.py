...
def eval_1(N,M,int):
    ...
    f = open("#Proposal_target_"+str(gr)+"_1_worst.txt",'a')
    ...
    f.close()
    # Y_MNISTを保存します
    with open('delete_target_'+str(gr)+'_1_worst.pkl', 'wb') as f:
...
def pred_test(int):
    ...
    # Y_MNISTを保存します
    with open('Test_target_'+str(gr)+'_1_worst.pkl', 'wb') as f:
...
def acc_u(idx):
    ...
    with open('Test_target_'+str(gr)+'_1_worst.pkl', 'rb') as f:
        Pred = pickle.load(f) 
    with open('Test_answer.pkl', 'rb') as f:
        Ans = pickle.load(f) 
    with open('delete_target_'+str(gr)+'_1_worst.pkl', 'rb') as f:
...
def acc_t(idx):
    ...
    f =open('FLCert_target_'+str(gr)+'_1_worst.txt','a')
    nn=0
    # print(delete_models)
    ...
    f.close() 
    # Y_MNISTを保存します
    with open('Acc_target_'+str(gr)+'_1_worst.pkl', 'wb') as FFF:
        pickle.dump(res, FFF) 
