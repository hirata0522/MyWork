...
def eval(N,M,int):
    ...
    f = open("#Proposal_untarget_"+str(gr)+".txt",'a')
    ...
    f.close()
    # Y_MNISTを保存します
    with open('delete_untarget_'+str(gr)+'.pkl', 'wb') as f:
...
def pred_test(int):
    ...
    # Y_MNISTを保存します
    with open('Test_untarget_'+str(gr)+'.pkl', 'wb') as f:
...
def acc_u(idx):
    ...
    with open('Test_untarget_'+str(gr)+'.pkl', 'rb') as f:
        Pred = pickle.load(f) 
    with open('Test_answer.pkl', 'rb') as f:
        Ans = pickle.load(f) 
    with open('delete_untarget_'+str(gr)+'.pkl', 'rb') as f:
    ...
    f =open('FLCert_untarget_'+str(gr)+'.txt','a')
    nn=0
    # print(delete_models)
    res=[]
    ...
    f.close()
    # Y_MNISTを保存します
    with open('Acc_untarget_'+str(gr)+'.pkl', 'wb') as FFF:
        pickle.dump(res, FFF)
...
def acc_t(idx):
    ...
    with open('Test_target_'+str(gr)+'.pkl', 'rb') as f:
        Pred = pickle.load(f) 
    with open('Test_answer.pkl', 'rb') as f:
        Ans = pickle.load(f) 
    with open('delete_target_'+str(gr)+'.pkl', 'rb') as f:
        delete_models = pickle.load(f) 
    ...
    f =open('FLCert_target_'+str(gr)+'.txt','a')
    nn=0
    # print(delete_models)
    ...
    f.close() 
    # Y_MNISTを保存します
    with open('Acc_target_'+str(gr)+'.pkl', 'wb') as FFF:
        pickle.dump(res, FFF) 
