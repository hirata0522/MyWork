...
def pred_test(int):
    ...
    # Y_MNISTを保存します
    with open('Test_artificial_target_'+str(gr)+'_worst_class.pkl', 'wb') as f:
        pickle.dump(Y_GROUP, f)
    with open('Test_artificial_answer.pkl', 'wb') as f:
...
def acc_u(idx):
    ...
    with open('Test_artificial_untarget_'+str(gr)+'_worst_class.pkl', 'rb') as f:
        Pred = pickle.load(f) 
    with open('Test_artificial_answer.pkl', 'rb') as f:
        Ans = pickle.load(f) 
    with open('delete_artificial_untarget_'+str(gr)+'_worst_class_fix.pkl', 'rb') as f:
    ...
    f =open('FLCert_artificial_untarget_'+str(gr)+'_worst_class_fix.txt','a')
    nn=0
    # print(delete_models)
    res=[]
    ...
    f.close()
    # Y_MNISTを保存します
    with open('Acc_artificial_untarget_'+str(gr)+'_worst_class_fix.pkl', 'wb') as FFF:
        pickle.dump(res, FFF)
...
def acc_t(idx):
    ...
    with open('Test_artificial_target_'+str(gr)+'_worst_class.pkl', 'rb') as f:
        Pred = pickle.load(f) 
    with open('Test_artificial_answer.pkl', 'rb') as f:
        Ans = pickle.load(f) 
    ...
    f =open('FLCert_artificial_target_'+str(gr)+'_worst_class_fix.txt','a')
    nn=0
    # print(delete_models)
    ...
    f.close() 
    # Y_MNISTを保存します
    with open('Acc_artificial_target_'+str(gr)+'_worst_class_fix.pkl', 'wb') as FFF:
        pickle.dump(res, FFF) 
